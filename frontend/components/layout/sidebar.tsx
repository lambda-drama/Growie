...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 md:pt-14 border-r border-border bg-sidebar">
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        {!isAuthenticated && (
          <div className="border-t border-sidebar-border pt-4">
            <p className="px-3 text-xs font-medium text-muted-foreground mb-2">Members Only</p>
        ...
        {!isAuthenticated && (
          <div className="rounded-lg border border-primary bg-primary/10 p-4">
            <p className="font-semibold text-foreground">Join Sumstack Today</p>
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-medium text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-foreground"
        >
        ...
        {/* Partner Logo */}
        <div className="border-t border-sidebar-border pt-4">
          <p className="text-xs text-muted-foreground">Data Partner</p>
